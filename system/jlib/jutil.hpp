...
extern void jlib_decl importGpgKeysFromSecrets(const char * secretCat, const char * secretPrefix, const char *gpgHomeDir, bool importPublicKeys, bool importPrivateKeys);
