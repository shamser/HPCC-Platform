...
public:
    ...
    virtual bool fireException(IException *e) { StringBuffer msg; OERRLOG("Scheduler error (skipping event): %d: %s", e->errorCode(), e->errorMessage(msg).str()); e->Release(); return true; }
private:
